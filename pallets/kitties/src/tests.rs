...
fn can_transfer() {
    new_test_ext().execute_with(|| {
        ...
        assert_eq!(
            last_event(),
            Event::kitties(RawEvent::KittyTransferred(100, 200, 0))
        );
    });
}
...
fn can_set_price() {
    new_test_ext().execute_with(|| {
        ...
        assert_eq!(
            last_event(),
            Event::kitties(RawEvent::KittyPriceUpdated(100, 0, Some(10)))
        );
        ...
        assert_eq!(
            last_event(),
            Event::kitties(RawEvent::KittyPriceUpdated(100, 0, None))
        );
    });
}
...
fn can_buy() {
    new_test_ext().execute_with(|| {
        ...
        assert_eq!(
            last_event(),
            Event::kitties(RawEvent::KittySold(100, 200, 0, 400))
        );
    });
}
